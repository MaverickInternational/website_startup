...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Maverick International | Home</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="contact.php" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight buttons-borders">Contact Us</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                            ...
                            <p class="m-0">Traditional software marketing is geared towards corporations who want to sell their products to others. However, not all software businesses are in the business of selling to other businesses. Some software businesses want to market their products internally.</p>
                            <a class="btn arrow-button arrow-button-white arrow-button-animate" href="service.php">
                                <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
