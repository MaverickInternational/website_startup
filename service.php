...
<!--                            <a href="quote.html" class="dropdown-item">Free Quote</a>-->
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto mt-5" style="max-width: 600px;">
                <h5 id="rm" class="fw-bold text-primary text-uppercase">Research & Development</h5>
            </div>
            <div class="row g-5">
            ...
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto mt-5" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">IT Consultation & Development</h5>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
